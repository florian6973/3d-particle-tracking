        ...
        for i, (inputs, labels) in enumerate(dataloaders['val']):
            ...
            for j in range(inputs.size()[0]):
                ...
                if images_so_far == num_images:
                    ...
                    return
        model.train(mode=was_tracnn.pyining)
...
def launch():
    model_ft, criterion, optimizer_ft, exp_lr_scheduler = build_model()
...
if __name__ == "__main__":
    ...
    #datadir = r'/n/holyscratch01/bertoldi_lab/fpollet/raw_data/pt_data'
    nclasses = 66 # to fix, val dataset?
    #build_dataset(datadir)
    dataloaders, dataset_sizes, class_names, device = load_data(datadir)
    launch()
